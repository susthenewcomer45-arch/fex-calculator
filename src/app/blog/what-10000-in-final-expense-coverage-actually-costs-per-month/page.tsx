...
export const metadata: Metadata = {
  ...
  description: 'Learn what $10,000 in final expense insurance costs monthly. Honest pricing breakdown for seniors age 50-85 without the sales pitch.',
  alternates: { canonical: 'https://nocallquotenow.com/blog/what-10000-in-final-expense-coverage-actually-costs-per-month' },
  openGraph: {
    title: 'What $10,000 in Final Expense Coverage Actually Costs Per Month | NocallQuoteNow',
    description: 'Learn what $10,000 in final expense insurance costs monthly. Honest pricing breakdown for seniors age 50-85 without the sales pitch.',
    url: 'https://nocallquotenow.com/blog/what-10000-in-final-expense-coverage-actually-costs-per-month',
  },
}
...
const sections: Section[] = [
  ...
  {
    "heading": "Age Is the Primary Driver of Your Monthly Cost",
    "paragraphs": [
  ...
  {
    "heading": "Health Status and Underwriting Affect Your Rate",
    "paragraphs": [
  ...
  {
    "heading": "Why Comparison Shopping Matters (Without the Spam Calls)",
    "paragraphs": [
  ...
  {
    "heading": "Making the Decision: Is $10,000 the Right Amount?",
    "paragraphs": [
