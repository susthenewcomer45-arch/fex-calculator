...
export const metadata: Metadata = {
  title: 'Is Final Expense Insurance Worth It? An Honest Breakdown | NocallQuoteNow',
  description: 'Learn if final expense insurance is worth it for seniors. Honest breakdown of costs, benefits, and alternatives to help you decide.',
  alternates: { canonical: 'https://nocallquotenow.com/blog/is-final-expense-insurance-worth-it-an-honest-breakdown' },
  openGraph: {
    title: 'Is Final Expense Insurance Worth It? An Honest Breakdown | NocallQuoteNow',
    description: 'Learn if final expense insurance is worth it for seniors. Honest breakdown of costs, benefits, and alternatives to help you decide.',
    url: 'https://nocallquotenow.com/blog/is-final-expense-insurance-worth-it-an-honest-breakdown',
  },
}
...
const sections: Section[] = [
  ...
  {
    "heading": "The Cost Factor: Why Age Matters",
    "paragraphs": [
  ...
  {
    "heading": "Who Benefits Most From Final Expense Insurance?",
    "paragraphs": [
  ...
  {
    "heading": "Making Your Decision Without the Pressure",
    "paragraphs": [
  ...
  return (
    <>
      ...
      <article className="max-w-2xl mx-auto px-4 py-12">
        ...
        <RelatedArticles currentSlug="is-final-expense-insurance-worth-it-an-honest-breakdown" />
      </article>
    </>
  )
}
